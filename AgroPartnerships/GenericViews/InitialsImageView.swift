...
extension UIImageView {
    ...
    public func setImageForName(string: String, backgroundColor: UIColor?, circular: Bool, textAttributes: [NSAttributedString.Key: AnyObject]?, gradient: Bool = false) {
    ...
    public func setImageForName(string: String, backgroundColor: UIColor?, circular: Bool, textAttributes: [NSAttributedString.Key: AnyObject]?, gradient: Bool = false, gradientColors: GradientColors?) {
    ...
    public func fontForFontName(name: String?) -> UIFont {
    ...
    private func imageSnapshot(text imageText: String, backgroundColor: UIColor, circular: Bool, textAttributes:  [NSAttributedString.Key: AnyObject], gradient: Bool, gradientColors: GradientColors) -> UIImage {
        ...
        let textSize: CGSize = imageText.size(withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14.0)])

//        let textSize: CGSize = tx.size(withAttributes: UITextAttributeFont)
//        let textSize: CGSize = imageText.size
